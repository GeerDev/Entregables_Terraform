# Entregables Terraform

## Crea una VPC (recurso VPC) que tenga acceso a internet, para ello debes tener en cuenta los siguientes puntos:
...
## Crea una subnet dentro la VPC, la subnet debe tener acceso a internet
...
## Añade una entrada en el user_data que instale Docker

## Crea un output con la IP publica de la instancia que has desplegado
